...
void InitOption(void)
{
	...
	D3DXCreateTextureFromFile(pDevice,
								"data/TEXTURE/OptionUI/HGP明朝E/FPD_OptionUI_TimenLimit_HGPmintyou.png",
								&s_apTextureMenu[0]);

	D3DXCreateTextureFromFile(pDevice,
								"data/TEXTURE/OptionUI/HGP明朝E/FPD_OptionUI_Point_HGPmintyou.png",
								&s_apTextureMenu[1]);

	D3DXCreateTextureFromFile(pDevice,
								"data/TEXTURE/OptionUI/HGP明朝E/FPD_OptionUI_SetCount_HGPmintyou.png",
								&s_apTextureMenu[2]);
