...
bool GetJoypadRelease(void);									// ジョイパッドトリガー処理(キー指定なし)
bool GetJoypadRelease(JOYKEY Key);								// ジョイパッドトリガー処理(プレイヤー指定なし)
bool GetJoypadRelease(int nPlayer);								// ジョイパッドプレス処理(プレイヤー指定のみ)
bool GetJoypadRelease(JOYKEY Key, int nPlayer);					// ジョイパッドトリガー処理(プレイヤー指定あり)
