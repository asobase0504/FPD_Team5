...
void InitFade(void)
{
	...
	// 頂点座標の設定処理
	pVtx[0].pos = D3DXVECTOR3(fWidth - fWidth, fHeight - fHeight, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(fWidth + fWidth, fHeight - fHeight, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(fWidth - fWidth, fHeight + fHeight, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(fWidth + fWidth, fHeight + fHeight, 0.0f);
